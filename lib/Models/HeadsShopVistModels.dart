...
class HeadsShopVisitModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'user_id': user_id,
      'feedback': feedback,
      'shop_visit_date': DateFormat('dd-MMM-yyyy').format(
          shop_visit_date ?? DateTime.now()), // Always set live date
      'shop_visit_time': DateFormat('HH:mm:ss').format(
          shop_visit_time ?? DateTime.now()), // Always set live time
      'booker_id': booker_id,
