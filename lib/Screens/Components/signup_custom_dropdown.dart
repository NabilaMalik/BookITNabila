...
class SignupCustomDropdown extends StatefulWidget {
  final String label;
  final IconData icon;
  ...
  @override
  _SignupCustomDropdownState createState() => _SignupCustomDropdownState();
}

class _SignupCustomDropdownState extends State<SignupCustomDropdown> {
  ...
  @override
  void didUpdateWidget(SignupCustomDropdown oldWidget) {
