            ...
            children: [
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text('Date: ${DateFormat('dd-MMM-yyyy : HH-mm-ss').format(DateTime.now())}', style: const pw.TextStyle(fontSize: 15)),
                    pw.Text('Receipt#: $recoveryId', style: const pw.TextStyle(fontSize: 15)),
                    pw.SizedBox(height: 20),
                    pw.Text(
                      'Shop Name: $shopName',
                    ...
                    pw.SizedBox(height: 10),
                    pw.Text('Payment Amount: $cashRecovery', style: const pw.TextStyle(fontSize: 15)),
                    pw.Text('Net Balance: $netBalance', style: const pw.TextStyle(fontSize: 15)),
                  ],
                ),
              ),
              pw.Spacer(),
