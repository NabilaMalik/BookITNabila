...
class NsmRsmBookerDetailsScreen extends StatefulWidget {
  final NsmRsmOrderModel booker;

  NsmRsmBookerDetailsScreen({required this.booker});

  @override
  _NSMBookerDetailsPageState createState() => _NSMBookerDetailsPageState();
}
class _NSMBookerDetailsPageState extends State<NsmRsmBookerDetailsScreen> {
  ...
  Future<void> _fetchAttendanceData() async {
    final response = await http.get(
      Uri.parse('https://cloud.metaxperts.net:8443/erp/test1/nsmrsmorderdetails/get/11/${widget.booker.booker_id}'),
