...
class NsmSmBookersDetailsScreen extends StatefulWidget {
  final NsmSmOrderModel booker;

  NsmSmBookersDetailsScreen({required this.booker});

  @override
  _NSMBookerDetailsPageState createState() => _NSMBookerDetailsPageState();
}
class _NSMBookerDetailsPageState extends State<NsmSmBookersDetailsScreen> {
  ...
  Future<void> _fetchAttendanceData() async {
    final response = await http.get(
      Uri.parse('https://cloud.metaxperts.net:8443/erp/test1/nsmsmorderdetails/get/11/${widget.booker.booker_id}'),
