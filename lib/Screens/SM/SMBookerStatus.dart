...
class SMBookerStatus extends StatefulWidget {
  @override
  _SMBookerStatusState createState() => _SMBookerStatusState();
}

class _SMBookerStatusState extends State<SMBookerStatus> {
  ...
  //     url: 'http://103.149.32.30:8080/ords/valor_trading/smbookerstatus/get/VT0038', // SSE server URL
  //     header: {
  //       'Authorization': 'Bearer your_token', // Headers (if required)
  //     },
  //   ).listen((event) {
  //     print('Event Data: ${event.data}'); // Receive event data
  //     print('Event ID: ${event.id}'); // Event ID (if available)
  //     print('Event Type: ${event.event}'); // Event type (if available)
  //   });
  // }
  ...
  Future<bool> _fetchAndSaveData() async {
    ...
    final url =
        "${Config.getApiUrlServerIP}${Config.getApiUrlERPCompanyName}${Config.getApiUrlSmBookersStatus}$user_id";
      ...
      child: Card(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: const EdgeInsets.symmetric(horizontal: 2.0, vertical: 1.0), // Reduced content padding
          ),
