...
class SmRsmBookerDetailsScreen extends StatefulWidget {
  final NsmRsmOrderModel booker;

  SmRsmBookerDetailsScreen({required this.booker});

  @override
  _NSMBookerDetailsPageState createState() => _NSMBookerDetailsPageState();
}
class _NSMBookerDetailsPageState extends State<SmRsmBookerDetailsScreen> {
  ...
  Future<void> _fetchAttendanceData() async {
    ...
    // );
    final response = await http.get(Uri.parse('${Config.getApiUrlServerIP}${Config.getApiUrlERPCompanyName}${Config.getApiUrlSmRsmOrderDetails}$user_id/${widget.booker.booker_id}')
    );
