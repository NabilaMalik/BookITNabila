...
import 'package:order_booking_app/Screens/SM/sm_homepage.dart';
...
class ShopVisitPage extends StatefulWidget {
  ...
  @override
  ShopVisitPageState createState() => ShopVisitPageState();
}

class ShopVisitPageState extends State<ShopVisitPage> {
  ...
  final TextEditingController SMNameController = TextEditingController(
      text: userName);
  ...
  Future<void> onDropdownTapBooker() async {
    // await fetchBookerNamesBySMDesignation();
  }
        ...
        child: Column(
          ...
          children: [
            _buildAnimatedTextField(
                'SM Name', SMNameController, Icons.person, readOnly: true),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              onChanged: (value) =>
                  setState(() {}), // Recheck button enable status
            ),
            Align(
