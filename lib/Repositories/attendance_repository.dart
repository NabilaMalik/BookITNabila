...
class AttendanceRepository{
  ...
  Future<List<AttendanceModel>> getAttendance() async{
    ...
    List<Map> maps = await dbClient.query(attendanceTableName,columns: ['id','date','timeIn','userId','latIn','lngIn,''bookerName','designation','city','address' ]);
  ...
  Future<int> delete(int id) async{
    var dbClient = await dbHelper.db;
    return await dbClient.delete(attendanceTableName,
