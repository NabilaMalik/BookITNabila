...
//     try {
//       await Config.fetchLatestConfig();
//       String apiUrl = '${Config.getApiUrlServerIP}${Config.getApiUrlERPCompanyName}${Config.postApiUrlLocation}';
//       debugPrint('🔄 [LOCATION-REPO] Posting to: $apiUrl');
//
//       var shopData = shop.toMap();
//
//       var request = http.MultipartRequest(
...
//
//       final response = await request.send();
//       debugPrint('📡 [LOCATION-REPO] Response status: ${response.statusCode}');
//
//       if (response.statusCode == 200 || response.statusCode == 201) {
//         debugPrint('✅ [LOCATION-REPO] Data posted successfully: ${shop.location_id}');
//
//         // ✅ CORRECT: Just update posted status, DON'T DELETE!
//         shop.posted = 1;
//         await update(shop);
//         debugPrint('✅ [LOCATION-REPO] Marked as posted: ${shop.location_id}');
//
//       } else {
//         final responseBody = await response.stream.bytesToString();
//         debugPrint('❌ [LOCATION-REPO] Server error: ${response.statusCode}, $responseBody');
//         // Don't throw - let it retry later
//       }
//     } catch (e) {
//       debugPrint('❌ [LOCATION-REPO] Error posting data: $e');
//       // Don't throw - let it retry later
//     }
//   }
//
