...
class DBHelper extends GetxService{
 /// In Dart, the underscore (_) at the beginning of a variable or method name indicates private access.
  ...
  _onCreate(Database db, int version){
    ...
    db.execute("CREATE TABLE $orderMasterTableName(orderMasterId INTEGER PRIMARY KEY,shopName TEXT,ownerName TEXT, phoneNumber TEXT,brand TEXT,total TEXT, creditLimit TEXT, requiredDelivery TEXT)");
    db.execute("CREATE TABLE $orderDetailsTableName (id INTEGER PRIMARY KEY,orderMasterId INTEGER, product TEXT, quantity TEXT, inStock TEXT, rate TEXT, amount TEXT, FOREIGN KEY(orderMasterId) REFERENCES $orderMasterTableName(orderMasterId))");
    ...
    db.execute("CREATE TABLE $productsTableName(id NUMBER PRIMARY KEY, product_code TEXT, product_name TEXT, uom TEXT ,price TEXT, brand TEXT, quantity TEXT, inStock TEXT)");
