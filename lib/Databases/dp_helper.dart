...
class DBHelper extends GetxService{
 /// In Dart, the underscore (_) at the beginning of a variable or method name indicates private access.
  ...
  _onCreate(Database db, int version){
    ...
    db.execute("CREATE TABLE $orderDetailsTableName (orderDetailsId TEXT, orderMasterId TEXT, product TEXT, quantity TEXT, inStock TEXT, rate TEXT, amount TEXT, FOREIGN KEY(orderMasterId) REFERENCES $orderMasterTableName(orderMasterId))");
    ...
    db.execute("CREATE TABLE $recoveryFormTableName(recoveryId TEXT PRIMARY KEY, shopName TEXT,currentBalance TEXT,cashRecovery TEXT,newBalance TEXT,date TEXT)");
